package com.hyperboat.normal.tobeclassified._0506;
...
public class _01 {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(new _01().twoSum(ints, 11)));
        System.out.println(new _01().threeSum(ints));
        System.out.println(new _01().threeSum2(ints, 5));
        System.out.println(new _01().fourSum(ints, 5));
    }
    /**
     * show 两数之和
     *
