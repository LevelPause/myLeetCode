...
class Sum {
    public static void main(String[] args) {
        ...
        System.out.println(new Sum().threeSum(ints));
        System.out.println(new Sum().threeSum2(ints, 5));
        System.out.println(new Sum().fourSum(ints, 5));
    }
    /**
     * show 两数之和
     *
